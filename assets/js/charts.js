...
(function () {
  ...
  function donut(host, opts) {
    ...
    const cSub = el("text", { x: cx, y: cy + 20, "text-anchor": "middle", "font-size": 14, fill: "var(--text-dim)" });
    ...
    rects.forEach((r) => {
      ...
      if (rw0 > 44 && rh0 > 24) {
        ...
        if (rh0 > 40) {
          ...
          const sub = el("text", { x: rx0 + 8, y: ry0 + 34, "font-size": 12.5, fill: "rgba(255,255,255,.88)" });
