...
(function () {
  ...
  const DICT = {
    tr: {
      ...
      "konteyner.kpiTotal": "Toplam Konteyner Elleçleme",
      "konteyner.kpiTopPort": "En Çok Konteyner Elleçlenen Liman",
      "konteyner.kpiTopCountry": "En Çok Konteyner Elleçlenen Ülke",
      ...
      "roro.kpiTotal": "Toplam taşınan araç sayısı",
      "roro.kpiTopType": "En çok taşınan araç cinsi (pazar payı)",
      "roro.kpiTopHat": "En yoğun hat",
      "roro.chartHat": "Hat yoğunlukları",
      "bogazlar.kpiGemi": "Toplam gemi geçiş sayısı",
      "bogazlar.kpiGrossTon": "Toplam gross ton",
      "bogazlar.kpiUgraksiz": "Uğraksız gemi sayısı",
      ...
      "kruvaziyer.kpiTotal": "Toplam kruvaziyer yolcu sayısı",
      "kruvaziyer.kpiTopPort": "En yoğun liman (pazar payı)",
      "kruvaziyer.kpiTopMonth": "En yoğun ay",
      "ui.marketShare": "pazar payı",
      "kabotaj.kpiArac": "Taşınan araç sayısı",
      "kabotaj.kpiAracMil": "Araç x Mil",
      "kabotaj.kpiYolcu": "Taşınan yolcu sayısı",
    ...
    en: {
      ...
      "konteyner.kpiTotal": "Total Container Handling",
      "konteyner.kpiTopPort": "Top Container Handling Port",
      "konteyner.kpiTopCountry": "Top Container Handling Country",
      ...
      "roro.kpiTopType": "Leading vehicle type (market share)",
      ...
      "kruvaziyer.kpiTotal": "Total cruise passengers",
      "kruvaziyer.kpiTopPort": "Busiest port (market share)",
